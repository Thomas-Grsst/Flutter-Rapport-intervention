...
class PdfService {
  ...
  /// Logo imprimé tant qu'aucun n'a été choisi dans les réglages.
  ...
  ///
  /// La mise en page se passe du logo quand il n'y en a pas : c'est ce qui
  /// arrive si le fichier livré est retiré.
